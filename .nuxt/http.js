...
export default (ctx, inject) => {
  ...
  const prefixUrl = process.browser
      ? (runtimeConfig.browserBaseURL || 'https://www.newsturk.com.tr/wp-json/wp/v2')
      : (runtimeConfig.baseURL || process.env._HTTP_BASE_URL_ || 'https://www.newsturk.com.tr/wp-json/wp/v2')
